...
- `weimingzhou_cover_recommend_title_20260623.png`
  ...
  - 视觉重点：主角与妹妹站船头、舰队聚拢、红色裂水、天上拆城。
  - 标题为本地真实字体叠加，不使用 AI 绘图模型生成文字。
...
- `make_cover_recommend_20260623.swift`
  - 当前推荐期封面标题叠加脚本。
...
推荐期优先用新稿测试点击，因为它在小图里更快给出三个信号：书名、末世舰队、地球被拆。旧稿更偏“舰队与未名岸已经成型”的中后期气质，可以留作后续换封或宣传物料。
